...
from app.application.effects.registry import register_effect_executor

from app.application.effects.executors.upload_image import execute_upload_image
from app.application.effects.executors.enqueue_processing import execute_enqueue_processing
from app.application.effects.executors.emit_domain_event import execute_emit_domain_event
from app.application.effects.executors.persist_relato import execute_persist_relato
