# app/application/effects/relato_executor.py
"""
Docstring for app.application.effects.relato_executor
"""
    ...
    def execute(self, effects: list):
        ...
        try:
            for effect in effects:
                # =====================================================
                # Idempotncia — skip se j executado com sucesso
                # =====================================================
                ...
                # =====================================================
                    ...
                    try:
                        ...
                        logger.exception("Erro ao emitir evento de domnio")
                ...
                # =====================================================
                    ...
                    try:
                        ...
                        uploaded_image_ids = self._upload_images(
                            effect.relato_id,
                            effect.image_refs,  # refs, no arquivos
                        )
            ...
            # =====================================================
            logger.warning(
                "Falha na execuo de efeitos. Iniciando rollback compensatrio | total_executados=%d",
    ...
    def execute_by_result(
        ...
        *,
        ...
        if effect_type == "PERSIST_RELATO":
            ...
            raise ValueError(f"Retry no suportado para effect_type={effect_type}")
