...
from app.application.effects.retry_classifier import RetryClassifier, DefaultRetryClassifier
from app.application.effects.retry_policy import RetryPolicy, DefaultRetryPolicy
...
class RetryEngine:
    ...
    def decide(self, result: EffectResult) -> EffectResult:
        """
        Calcula a deciso de retry para o EffectResult dado e retorna um novo EffectResult
        refletindo essa deciso (ERROR ou RETRYING).
        """
