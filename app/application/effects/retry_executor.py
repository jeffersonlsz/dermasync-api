...
from app.application.effects.registry import get_effect_executor
from app.application.effects.loader import load_effect_result
...
def retry_effect(effect_result_id: str) -> EffectResult:
    ...
    if not executor:
        raise ValueError(f"Efeito no suportado para retry: {effect_ref}")
