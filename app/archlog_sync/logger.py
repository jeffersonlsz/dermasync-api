...
# -*- coding: utf-8 -*-
"""Este mdulo contm funes para registrar logs de eventos de forma estruturada em um arquivo JSONL."""
import json
import logging
...
async def registrar_log(log_data: dict):
    ...
    # grava linha JSONL (j inclui a timestamp que veio no log_data)
