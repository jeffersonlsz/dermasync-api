...
"""
Este mdulo contm funes para gerar diagramas de sequncia em Mermaid a partir de eventos de log.
"""
...
def to_sequence_diagram(events: list[dict]) -> str:
    logger.info("Gerando diagrama de sequncia Mermaid a partir dos eventos de log")
