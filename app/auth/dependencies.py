"""
Dependncias de autenticao/autorizaao com Firebase ID token como credencial oficial.
"""
...
async def require_admin(current_user: User = Depends(get_current_user)) -> User:
    """
    Dependncia explcita que garante que o usurio possui o papel de admin.
    Verifica 'role' e uma whitelist temporria de e-mails.
    """
