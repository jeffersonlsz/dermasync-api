...
# ============================================================
# Linguagem do domnio (Ubiquitous Language)
# ============================================================
...
# ============================================================
# Contratos observveis (vindos de fora do domnio UX)
# ============================================================
...
def aggregate_progress(
    ...
    - No executa efeitos
    - No conhece infraestrutura
    - Deriva narrativa cognitiva a partir de evidncias (EffectResult)
    """
    ...
    # --------------------------------------------------------
    # Inferncia semntica de cada UXStep
    # --------------------------------------------------------
    for definition in step_definitions:
        ...
        # Caso 3 — Houve tentativa, mas no sucesso (ACTIVE)
        first_event = min(related_effects, key=lambda e: e.created_at)
    ...
    # --------------------------------------------------------
    # Derivaes globais (invariantes do agregado)
    # --------------------------------------------------------
...
def find_step(progress: UXProgress, step_id: str) -> Optional[UXStep]:
    ...
    - No lana exceo
    - No infere nada
    - Expressa inteno semntica do domnio
    """
