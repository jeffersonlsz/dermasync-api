    ...
    for diretorio in diretorios:
        ...
        for arquivo in arquivos_txt:
            ...
            if source == "local-youtube":
                ...
                conteudo = "\n".join(
                    conteudo[1:]
                ).strip()  # Remove a primeira linha (link)
...
if __name__ == "__main__":
    _diretorios = [
        "D:\\workspace_projects_001\\fotos_dados\\resultados\\videos_transcripts"
    ]
    diretorios = [
        {
            "fonte": "facebook",
    ...
    print("ðŸ“‚ Lendo arquivos dos diretórios:", diretorios)
    # registros = processar_diretorios(diretorios, 'local-youtube')
    # print(f"ðŸ“„ Encontrados {len(registros)} registros nos diretórios.")
