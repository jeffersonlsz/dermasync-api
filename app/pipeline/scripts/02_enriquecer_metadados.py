...
def gerar_prompt(texto):
    return (
        "Extraia idade, gnero, principais sintomas, regies do corpo afetadas, medicamentos e durao de uso, produtos naturais e terapias realizadas. "
        "Ignore nomes prprios. Responda apenas em JSON, se no encontrou o dado, preencha com 'ausente':\n"
        '{"idade": ..., "genero": ..., "sintomas": [...], "regioes_afetadas": [...], '
        '"produtos_naturais": [...], "terapias_realizadas": [...], '
        '"medicamentos": [{"nome": "...", "frequencia": "...", "duracao": "..."}]}, '
        '"resumo_descritivo: "aqui  um resumo pequeno sobre o que o texto diz, para servir como titulo e subtitulo"   \n\n'
        f"TEXTO:\n{texto}"
    )
