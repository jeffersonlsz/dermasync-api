...
if __name__ == "__main__":
    ...
    if not os.path.exists(DIRETORIO_JSONS_ENRIQUECIDOS):
        print(f"‚ùå DiretÛrio {DIRETORIO_JSONS_ENRIQUECIDOS} n„o encontrado.")
        exit(1)
    ...
    if not relatos:
        print("‚ùå Nenhum relato encontrado para processar.")
        exit(1)
    ...
    print(f"‚úÖ {len(segmentos)} segmentos salvos em {output_path}")
