...
# Arquivo de entrada e sada (pode ser o mesmo se quiser sobrescrever)
...
with open(input_file, "r", encoding="utf-8") as f_in, open(
    ...
    for line in f_in:
        ...
        # Escreve a linha modificada no arquivo de sada
        f_out.write(json.dumps(data, ensure_ascii=False) + "\n")

print(
    f"Campo 'origem':'local' adicionado a todas as linhas. Arquivo salvo em: {output_file}"
)
