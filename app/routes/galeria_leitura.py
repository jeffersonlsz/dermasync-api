...
async def ler_relato(
    ...
    if user_profile and relato_base:
     ...
     # ============================================================
    # 5ï¸âƒ£ Resolver ExposureStage (controla o que será exibido)
    # ============================================================
    ...
    # ============================================================
    # ðŸ”“ Intent: expand (liberação explícita do usuário)
    # ============================================================
    ...
    # ============================================================
    # 6ï¸âƒ£ Projetar conteúdo conforme stage
    # ============================================================
    ...
    # ðŸ”¹ Imagens (já estruturadas como dict com type + path)
