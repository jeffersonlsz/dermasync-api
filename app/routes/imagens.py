...
async def get_imagens_publicas(
    ...
    anexar signed URLs. Se thumb=True, pede ao servio thumbnails assinadas
    quando disponveis (melhor para exibio em grid).
    """
    ...
    try:
        ...
        for raw_meta in imagens:
            ...
            # Normalizao inteligente quando signed URLs foram solicitadas
            if include_signed_url:
                # Possveis locais onde o servio pode ter colocado signed urls:
                ...
                # inicializa campos cannicos
                meta.setdefault("thumb_url", None)
                meta.setdefault("image_url", None)

                # 1) se o servio j devolveu thumb_url/image_url explcitos, usa-os
                ...
                if isinstance(signed_source, dict):
                    ...
                    # se o servio devolveu 'signed_urls' como lista dentro do dict
                ...
                # 5) heurstica final: se thumb=True mas no veio thumb_url, tente inferir campo 'thumbnail'/'thumb'
        ...
        # caso listar_imagens_publicas no aceite parmetro 'thumb' (retrocompat)
        ...
        try:
            ...
            logger.exception("Erro ao listar imagens pblicas (fallback tambm falhou).")
...
async def get_imagem_publica(
    ...
    try:
        ...
        # se o servio retornou signed structure em 'signed_url', normalizamos para a resposta esperada
        return imagem_data
    except HTTPException:
        raise
    except Exception as e:
