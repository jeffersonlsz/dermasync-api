...
from app.application.ux.ux_adapter_core import effect_result_to_ux_effect
...
def get_relato_progress(
    ...
    """
    Retorna o progresso semntico de um relato.
    ...
    try:
        ...
        # 2️⃣ Converter para UXEffectRecord (modelo cannico via adapter)
        effects = [
            ux
        ...
        # ⚠️ Garantia de ordenao temporal
    ...
    # 4️⃣ Serializao explcita (contrato pblico)
    return {
