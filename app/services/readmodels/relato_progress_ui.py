...
STATUS_LABELS = {
    ...
    "COMPLETED": "Relato concludo",
    "FAILED": "Falha ao processar relato",
    "PENDING": "Aguardando incio",
...
STEP_LABELS = {
    ...
    "ENQUEUE_PROCESSING": "Processar contedo",
}
...
def build_relato_progress_ui(
    *,
    ...
    """
    Adapter UX:
    Converte o read model tcnico em um contrato estvel para UI.
    """
    ...
    # -----------------------------
    if status == "COMPLETED":
        summary = "Relato concludo com sucesso"
