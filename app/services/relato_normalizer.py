...
def normalize_relato_document(raw: Dict[str, Any]) -> Dict[str, Any]:
    """
    Garante que o documento respeite o schema esperado pelo domnio.
    Corrige divergncias legadas do Firestore.
    Retorna sempre uma estrutura cannica estvel.
    """
    ...
    # ---------------------------------------------------------
    # image_refs → sempre lista[{type: str, path: str}]
    # ---------------------------------------------------------
