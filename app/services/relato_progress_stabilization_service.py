...
class RelatoProgressStabilizationService:
    ...
    # ------------------------------------------------------
    # Regra de estabilidade (ncleo conceitual)
    # ------------------------------------------------------
    def _is_progress_stable(
        ...
        """
        Um progresso  estvel quando todas as intenes (effects)
        tiveram sucesso no ltimo evento observado.
        """
