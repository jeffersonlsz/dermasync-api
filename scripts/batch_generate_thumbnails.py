"""
Batch idempotente de geraÁ„o de thumbnails para imagens no Firestore.

- N√ÉO cria documentos
- N√ÉO remove dados
- N√ÉO altera relatos
...
def run_batch(limit: int | None, dry_run: bool):
    ...
    if dry_run:
        print("‚ö†Ô∏è DRY-RUN ATIVO: nenhuma alteraÁ„o ser· feita.")
    ...
    for doc in docs:
        ...
        if dry_run:
            print(f"  ‚Üí geraria thumbnail em {thumb_path}")
            processed += 1
            continue
