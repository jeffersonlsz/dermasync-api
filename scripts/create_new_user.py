...
# python scripts/create_new_user.py --email usuario.teste.2@dermasync.com --password Usuario123! --name "Usuario Teste 2" --role usuario_logado
...
# 2. Agora os imports de app sao seguros
...
def create_user(email, password, name, role):
    ...
    print(f"[*] Criando usuario: {email} | Role: {role}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", default="Novo Usuario")
