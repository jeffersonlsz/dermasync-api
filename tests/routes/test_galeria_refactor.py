...
async def test_relatos_galeria_publica_canonical_route_does_not_exist(client: AsyncClient):
    ...
    # Se o router de galeria NÃO tem prefixo /relatos no main.py, este path deveria dar 404
    # MAS no teste anterior eu coloquei o path /galeria/public (sem /relatos no início)
    # Vou corrigir para o path que realmente queremos testar que NÃO existe.
