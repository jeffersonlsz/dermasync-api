...
def test_effect_result_persist_and_fetch_success():
    ...
    if not os.getenv("RUN_FIRESTORE_INTEGRATION"):
        ...
        pytest.skip("Defina RUN_FIRESTORE_INTEGRATION=1 para executar integraÃÂ§ÃÂ£o real com Firestore.")



    from app.application.effects.persist_firestore import persist_effect_result_firestore

    from app.application.effects.fetch_firestore import fetch_effect_result_success
