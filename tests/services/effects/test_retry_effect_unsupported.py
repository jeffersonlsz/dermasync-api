...
from app.application.effects.retry_executor import retry_effect
from app.application.effects.registry import clear_registry
...
def test_retry_effect_unsupported_type_raises():
    ...
    with patch(
        "app.application.effects.loader.load_effect_result",
