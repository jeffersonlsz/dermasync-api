...
async def test_integracao_fase_01_e_02():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        txt_path.write_text("Tenho 35 anos e usei Cetaphil por 10 dias. Ajudou bastante nas coceiras.")
        ...
        for campo in ["idade", "genero", "classificacao_etaria", "llm_processamento", "status_llm"]:
